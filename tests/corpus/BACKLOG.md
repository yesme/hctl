...
| 30 | cutover 认账既有 UNRECORDED（仅此类）为 warning；tree-reuse 归属祖先绑定；cutover 后债仍 error；回退/双翻转/不可判定 INVALID_CUTOVER | D-38/D-39 | codex-27k §3.3 | `cases/30-bootstrap-cutover.sh` |
